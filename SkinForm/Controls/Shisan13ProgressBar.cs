...
{
    /// <summary>
    /// Shisan13 design-like progress bar
    /// </summary>
    public class Shisan13ProgressBar : ProgressBar, IShisan13Control
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Shisan13ProgressBar"/> class.
        /// </summary>
        public Shisan13ProgressBar()
        {
        ...
        /// </value>
        [Browsable(false)]
        public shisan13Manager SkinManager
        {
            get { return shisan13Manager.Instance; }
        }
