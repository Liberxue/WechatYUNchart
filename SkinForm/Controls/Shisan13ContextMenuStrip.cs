...
{
    public class Shisan13ContextMenuStrip : ContextMenuStrip, IShisan13Control
    {
        ...
        public Shisan13ContextMenuStrip()
        {
            Renderer = new Shisan13ToolStripRender();
    ...
    public class Shisan13ToolStripMenuItem : ToolStripMenuItem
    {
        public Shisan13ToolStripMenuItem()
        {
            AutoSize = false;
        ...
        protected override ToolStripDropDown CreateDefaultDropDown()
        {
            ...
            var defaultDropDown = new Shisan13ContextMenuStrip();
    ...
    internal class Shisan13ToolStripRender : ToolStripProfessionalRenderer, IShisan13Control
    {
        //Properties for managing the Shisan13 design properties
        public int Depth { get; set; }
        public shisan13Manager SkinManager { get { return shisan13Manager.Instance; } }
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e)
        {
            ...
            //Ripple animation
            var toolStrip = e.ToolStrip as Shisan13ContextMenuStrip;
            if (toolStrip != null)
            {
