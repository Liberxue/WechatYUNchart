...
{
    public class Shisan13TabSelector : Control, IShisan13Control
    {
        [Browsable(false)]
		...
		private Shisan13TabControl baseTabControl;
        public Shisan13TabControl BaseTabControl
        {
